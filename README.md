...
3. Wait for setup to complete — the first build runs automatically and takes ~10 minutes (pulls images, restores packages, seeds the database)
4. Once setup finishes, open three terminals and run:
